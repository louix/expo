...
constexpr const char *ABI45_0_0EXGLContextsMapPropertyName = "__EXGLContexts";
...
void createWebGLRenderer(jsi::Runtime &runtime, ABI45_0_0EXGLContext *ctx, initGlesContext viewport, jsi::Object&& global) {
  ensurePrototypes(runtime);
  jsi::Object gl = ctx->supportsWebGL2
    ? createWebGLObject(
          runtime, ABI45_0_0EXWebGLClass::WebGL2RenderingContext, {static_cast<double>(ctx->ctxId)})
          .asObject(runtime)
    : createWebGLObject(
          runtime, ABI45_0_0EXWebGLClass::WebGLRenderingContext, {static_cast<double>(ctx->ctxId)})
          .asObject(runtime);
  ...
  jsi::Value jsContextMap = global.getProperty(runtime, ABI45_0_0EXGLContextsMapPropertyName);
  if (jsContextMap.isNull() || jsContextMap.isUndefined()) {
    global.setProperty(runtime, ABI45_0_0EXGLContextsMapPropertyName, jsi::Object(runtime));
  }
  global.getProperty(runtime, ABI45_0_0EXGLContextsMapPropertyName)
      .asObject(runtime)
...
std::string getConstructorName(ABI45_0_0EXWebGLClass value) {
  switch (value) {
    case ABI45_0_0EXWebGLClass::WebGLRenderingContext:
      return "WebGLRenderingContext";
    case ABI45_0_0EXWebGLClass::WebGL2RenderingContext:
      return "WebGL2RenderingContext";
    case ABI45_0_0EXWebGLClass::WebGLObject:
      return "WebGLObject";
    case ABI45_0_0EXWebGLClass::WebGLBuffer:
      return "WebGLBuffer";
    case ABI45_0_0EXWebGLClass::WebGLFramebuffer:
      return "WebGLFramebuffer";
    case ABI45_0_0EXWebGLClass::WebGLProgram:
      return "WebGLProgram";
    case ABI45_0_0EXWebGLClass::WebGLRenderbuffer:
      return "WebGLRenderbuffer";
    case ABI45_0_0EXWebGLClass::WebGLShader:
      return "WebGLShader";
    case ABI45_0_0EXWebGLClass::WebGLTexture:
      return "WebGLTexture";
    case ABI45_0_0EXWebGLClass::WebGLUniformLocation:
      return "WebGLUniformLocation";
    case ABI45_0_0EXWebGLClass::WebGLActiveInfo:
      return "WebGLActiveInfo";
    case ABI45_0_0EXWebGLClass::WebGLShaderPrecisionFormat:
      return "WebGLShaderPrecisionFormat";
    case ABI45_0_0EXWebGLClass::WebGLQuery:
      return "WebGLQuery";
    case ABI45_0_0EXWebGLClass::WebGLSampler:
      return "WebGLSampler";
    case ABI45_0_0EXWebGLClass::WebGLSync:
      return "WebGLSync";
    case ABI45_0_0EXWebGLClass::WebGLTransformFeedback:
      return "WebGLTransformFeedback";
    case ABI45_0_0EXWebGLClass::WebGLVertexArrayObject:
...
void attachClass(
    jsi::Runtime &runtime,
    ABI45_0_0EXWebGLClass webglClass,
    std::function<void(ABI45_0_0EXWebGLClass webglClass)> installPrototypes) {
...
void ensurePrototypes(jsi::Runtime &runtime) {
  ...
  auto inheritFromJsObject = [&runtime](ABI45_0_0EXWebGLClass classEnum) {
  ...
  {
    inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGLRenderingContext);
    auto prototype =
        runtime.global()
            .getProperty(runtime, jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI45_0_0EXWebGLClass::WebGLRenderingContext)))
            .asObject(runtime)
  ...
  {
    inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGL2RenderingContext);
    auto prototype =
        runtime.global()
            .getProperty(runtime, jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI45_0_0EXWebGLClass::WebGL2RenderingContext)))
            .asObject(runtime)
            .getPropertyAsObject(runtime, "prototype");
    installConstants(runtime, prototype);
  ...
  inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGLObject);

  jsi::Object webglObjectClass =
      runtime.global()
          .getProperty(
              runtime,
              jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI45_0_0EXWebGLClass::WebGLObject)))
          .asObject(runtime);
  auto inheritFromWebGLObject = [&runtime, &webglObjectClass](ABI45_0_0EXWebGLClass classEnum) {
    jsClassExtend(
        runtime,
        webglObjectClass,
  ...
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLBuffer);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLFramebuffer);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLProgram);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLRenderbuffer);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLShader);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLTexture);
  inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGLUniformLocation);
  inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGLActiveInfo);
  inheritFromJsObject(ABI45_0_0EXWebGLClass::WebGLShaderPrecisionFormat);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLQuery);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLSampler);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLSync);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLTransformFeedback);
  inheritFromWebGLObject(ABI45_0_0EXWebGLClass::WebGLVertexArrayObject);
}

void installConstants(jsi::Runtime &runtime, jsi::Object &gl) {
#define GL_CONSTANT(name) gl.setProperty(runtime, #name, static_cast<double>(GL_##name));
#include "ABI45_0_0EXGLConstants.def"
#undef GL_CONSTANT
}
