...
constexpr const char *ABI47_0_0EXGLContextsMapPropertyName = "__EXGLContexts";
...
void createWebGLRenderer(jsi::Runtime &runtime, ABI47_0_0EXGLContext *ctx, initGlesContext viewport, jsi::Object&& global) {
  ensurePrototypes(runtime);
  jsi::Object gl = ctx->supportsWebGL2
    ? createWebGLObject(
          runtime, ABI47_0_0EXWebGLClass::WebGL2RenderingContext, {static_cast<double>(ctx->ctxId)})
          .asObject(runtime)
    : createWebGLObject(
          runtime, ABI47_0_0EXWebGLClass::WebGLRenderingContext, {static_cast<double>(ctx->ctxId)})
          .asObject(runtime);
  ...
  jsi::Value jsContextMap = global.getProperty(runtime, ABI47_0_0EXGLContextsMapPropertyName);
  if (jsContextMap.isNull() || jsContextMap.isUndefined()) {
    global.setProperty(runtime, ABI47_0_0EXGLContextsMapPropertyName, jsi::Object(runtime));
  }
  global.getProperty(runtime, ABI47_0_0EXGLContextsMapPropertyName)
      .asObject(runtime)
...
std::string getConstructorName(ABI47_0_0EXWebGLClass value) {
  switch (value) {
    case ABI47_0_0EXWebGLClass::WebGLRenderingContext:
      return "WebGLRenderingContext";
    case ABI47_0_0EXWebGLClass::WebGL2RenderingContext:
      return "WebGL2RenderingContext";
    case ABI47_0_0EXWebGLClass::WebGLObject:
      return "WebGLObject";
    case ABI47_0_0EXWebGLClass::WebGLBuffer:
      return "WebGLBuffer";
    case ABI47_0_0EXWebGLClass::WebGLFramebuffer:
      return "WebGLFramebuffer";
    case ABI47_0_0EXWebGLClass::WebGLProgram:
      return "WebGLProgram";
    case ABI47_0_0EXWebGLClass::WebGLRenderbuffer:
      return "WebGLRenderbuffer";
    case ABI47_0_0EXWebGLClass::WebGLShader:
      return "WebGLShader";
    case ABI47_0_0EXWebGLClass::WebGLTexture:
      return "WebGLTexture";
    case ABI47_0_0EXWebGLClass::WebGLUniformLocation:
      return "WebGLUniformLocation";
    case ABI47_0_0EXWebGLClass::WebGLActiveInfo:
      return "WebGLActiveInfo";
    case ABI47_0_0EXWebGLClass::WebGLShaderPrecisionFormat:
      return "WebGLShaderPrecisionFormat";
    case ABI47_0_0EXWebGLClass::WebGLQuery:
      return "WebGLQuery";
    case ABI47_0_0EXWebGLClass::WebGLSampler:
      return "WebGLSampler";
    case ABI47_0_0EXWebGLClass::WebGLSync:
      return "WebGLSync";
    case ABI47_0_0EXWebGLClass::WebGLTransformFeedback:
      return "WebGLTransformFeedback";
    case ABI47_0_0EXWebGLClass::WebGLVertexArrayObject:
...
void attachClass(
    jsi::Runtime &runtime,
    ABI47_0_0EXWebGLClass webglClass,
    std::function<void(ABI47_0_0EXWebGLClass webglClass)> installPrototypes) {
...
void ensurePrototypes(jsi::Runtime &runtime) {
  ...
  auto inheritFromJsObject = [&runtime](ABI47_0_0EXWebGLClass classEnum) {
  ...
  {
    inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGLRenderingContext);
    auto prototype =
        runtime.global()
            .getProperty(runtime, jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI47_0_0EXWebGLClass::WebGLRenderingContext)))
            .asObject(runtime)
  ...
  {
    inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGL2RenderingContext);
    auto prototype =
        runtime.global()
            .getProperty(runtime, jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI47_0_0EXWebGLClass::WebGL2RenderingContext)))
            .asObject(runtime)
            .getPropertyAsObject(runtime, "prototype");
    installConstants(runtime, prototype);
  ...
  inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGLObject);

  jsi::Object webglObjectClass =
      runtime.global()
          .getProperty(
              runtime,
              jsi::PropNameID::forUtf8(runtime, getConstructorName(ABI47_0_0EXWebGLClass::WebGLObject)))
          .asObject(runtime);
  auto inheritFromWebGLObject = [&runtime, &webglObjectClass](ABI47_0_0EXWebGLClass classEnum) {
    jsClassExtend(
        runtime,
        webglObjectClass,
  ...
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLBuffer);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLFramebuffer);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLProgram);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLRenderbuffer);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLShader);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLTexture);
  inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGLUniformLocation);
  inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGLActiveInfo);
  inheritFromJsObject(ABI47_0_0EXWebGLClass::WebGLShaderPrecisionFormat);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLQuery);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLSampler);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLSync);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLTransformFeedback);
  inheritFromWebGLObject(ABI47_0_0EXWebGLClass::WebGLVertexArrayObject);
}

void installConstants(jsi::Runtime &runtime, jsi::Object &gl) {
#define GL_CONSTANT(name) gl.setProperty(runtime, #name, static_cast<double>(GL_##name));
#include "ABI47_0_0EXGLConstants.def"
#undef GL_CONSTANT
}
